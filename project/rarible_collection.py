...
"""
json_file = "data/rarible_coll-202204031634.json"

f = open(json_file, 'r')
collections = json.loads(f.read())
f.close()

if verbose: print("rarible_coll: {0} collections".format(len(collections)))
...
url = "https://api.rarible.org/v0.1/collections/all?blockchains=ETHEREUM&size=2".format()
...
for coll in collections:
    ...
    #
    url = "https://api.rarible.org/v0.1/collections/all?blockchains=E".format()
